...
# MoGaze dataset configuration
C.mogaze_anno_dir = osp.join(C.root_dir, 'data/mogaze/')
...
# MoGaze has 22 joints with 3 rotation values each = 66 dimensions (same as H36M structure)
C.motion.dim = 66
...
## Motion Network mlp
dim_ = 66  # 22 joints * 3 rotations (same as H36M)
C.motion_mlp = edict()
